        ...
        <div class="col-sm-7">
          <div class="thumbnail no-border">
            <div class="caption indent">
              ...
              <p>
                Binding paper, also known as leather-filled paper, is suitable for PVC binding paper made of paper as the base material and polyvinyl chloride plastic as the surface layer after calendering or coating, printing, embossing or foaming.
              </p> 
              <p>
                 Leather-filled paper is the world's most popular environmentally friendly packaging paper. The paper is soft, with a leather feel, and the surface layer is wear-resistant and foldable. It uses environmentally friendly water-based inks, or quaint or stylish.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="thumbnail no-border">
            <div class="caption indent">
              ...
              <p>Originating from the Netherlands, it is made of cloth and special paper pasted. flat surface. It is suitable for all kinds of hardcover books, notepads, folders, photobooks and all kinds of noble and elegant jewelry, jewelry, perfume, watches, wine and other packaging.
                Binding cloths are roughly divided into two categories according to their uses: </p>
               <p >1: Binding cloth for packaging</p> 
                <p >  There are various colors, which can be used for direct bronzing, embossing and other processes. </p>
                <p>2: printing binding cloth</p>
